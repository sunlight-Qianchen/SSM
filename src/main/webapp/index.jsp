            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="email" class="form-control" id="email_update_input" placeholder="email@li.com">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="email_add_input" class="col-sm-2 control-label">email</label>
                        <div class="col-sm-10">
                            <input type="text" name="email" class="form-control" id="email_add_input" placeholder="email@li.com">
                            <span class="help-block"></span>
                        </div>
                    </div>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-8">
            <button id="emp_add_model_btn" class="btn btn-primary">新增</button>
    ...
    function build_emps_table(result) {
        ...
        $.each(emps, function (index, item) {
            ...
            <button type="button" class="btn btn-primary btn-sm" aria-label="Left Align" >
                                    ...
                                    编辑</button>
             */
            var editBtn = $("<button></button>").addClass("btn btn-primary btn-sm edit_btn").append($("<span></span>").addClass("glyphicon glyphicon-align-left")).append("编辑");
            ...
            $("<tr></tr>").append(checkBoxTd)
                .append(empIdTd).append(empNameTd).append(gender).append(email).append(deptNameId)
                .append(btnTd)
    ...
    function getDepts(ele) {
        ...
        $.ajax({
            ...
            success:function (result){
                /*
                {"code":100,"msg":"处理成功！",
                "extend":{"depts":[{"id":1,"deptName":"开发部"},{"id":2,"deptName":"测试部"}]}}
                 */
                //console.log(result);
                //显示部门信息在下拉列表中
                // $("#dept_add_select")
